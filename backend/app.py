...
# Routers
from routers import chores, calendar, meals, adhoc, bills, inventory, polls, settings_api, modules, shopping, status, recipes, pairing, routines, rewards, allowances, feedback, pets, noticeboard, assignments, expenses, house_rules, tenancy, freezer, selfcare
