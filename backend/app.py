...
_CSRF_EXEMPT_PATHS = {"/ws", "/api/billing/webhook", "/api/auth/signup", "/api/auth/login", "/api/auth/password-login", "/api/auth/password/reset-request", "/api/auth/password/reset", "/api/sync/push"}
